      ...
      <div className="relative grid grid-cols-1 md:grid-cols-2  gap-20">
        ...
        <div className="flex justify-between flex-col py-4">
          <motion.div
            ...
            <h3 className="text-2xl font-bold dark:text-white text-[#F56E14]">
          ...
          <div className="flex gap-4 pt-12 md:pt-0">
            <button
              onClick={handlePrev}
              className="h-7 w-7 rounded-full bg-[#F56E14] dark:bg-neutral-800 flex items-center justify-center group/button">
